...
def test_discover_extendedinfo(name, rsp_dest, rsp_dict, exp_code, exp_model, exp_hw_version, exp_sw_version, exp_serial, request):
    # Create discover instance
    context = request.getfixturevalue("context")
    context.start_discover(rsp_dest, rsp_dict)
...
def test_discover_gateway_info(name, flag_skip_guid, rsp_dest, rsp_dict, exp_host, exp_guid, request):
    # Create discover instance
    context = request.getfixturevalue("context")
    context.start_discover(rsp_dest, rsp_dict)
    ...
    gw_info = context.discover.discover_gateway_info(flags)
