...
async def test_requestGuid(name, exp_dst_addr, exp_svc_id, exp_obj_type, exp_obj_id, exp_prop_id, rsp_flags, rsp_data, exp_value, exp_except, request):
    ...
    if exp_except == None:
        value = await api.requestGuid(retries=1, timeout=5)
...
async def test_requestValue(name, test_nr, test_dest, exp_dst_addr, exp_svc_id, exp_obj_type, exp_obj_id, exp_prop_id, rsp_flags, rsp_data, exp_value, exp_except, request):
    ...
    if exp_except == None:
        value = await api.requestValue(param, test_dest, retries=1, timeout=5)
...
async def test_updateValue(name, test_nr, test_dest, test_value_update, exp_dst_addr, exp_svc_id, exp_obj_type, exp_obj_id, exp_prop_id, rsp_flags, rsp_data, exp_value, exp_except, request):
    ...
    if exp_except == None:
        value = await api.updateValue(param, test_value_update, test_dest, retries=1, timeout=5)
...
async def test_requestInfos(name, values_fixture, run_receive, exp_src_addr, exp_dst_addr, exp_svc_id, exp_obj_type, exp_obj_id, exp_prop_id, rsp_flags, exp_except, request):
    ...
    if exp_except == None:
        rsp_data = await api.requestInfos(req_data, retries=1, timeout=5)
...
async def test_requestValues(name, values_fixture, run_receive, rsp_flags, exp_value, exp_error, exp_except, request):
    ...
    if exp_except == None:
        rsp_data = await api.requestValues(req_data, retries=1, timeout=5)
...
async def test_requestMessage(name, test_nr, exp_svc_id, exp_obj_type, exp_obj_id, exp_prop_id, rsp_flags, rsp_data, exp_value, exp_except, request):
    ...
    if exp_except == None:
        msg = await api.requestMessage(test_nr, retries=1, timeout=5)
