...
def test_request_virtual(name, test_nr, test_dest, rsp_frm_flags, rsp_data,exp_value, exp_except, request):
    ...
    api.request_guid(retries=1, timeout=5)
